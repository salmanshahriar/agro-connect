...
import { Search, MapPin, ShoppingCart, Filter, MessageCircle } from "lucide-react"
...
export default function BuyerMarketplace() {
  ...
  const locations = ["all", "Jessore", "Bogra", "Dhaka", "Chittagong", "Sylhet"]
    ...
    <div className="p-4 md:p-8">
      ...
      <div className="mb-6 space-y-4">
        ...
        <div className="relative">
          ...
          <Input
            placeholder={t("marketplace.search_placeholder") || "Search for produce or farmers..."}
            value={searchQuery}
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2">
              {categories.map((category) => (
                ...
                >
                  {category === "all" ? t("marketplace.all_products") || "All" : category}
                </Button>
              ))}
            </div>
          </div>
            ...
            <div className="flex flex-wrap gap-2">
              {locations.map((location) => (
                <Button
                  ...
                  className={selectedLocation === location ? "bg-primary hover:bg-primary/90" : ""}
                >
        ...
        {filteredProducts.map((product) => (
          <Card key={product.id} className="overflow-hidden hover:shadow-lg transition-shadow">
            <div className="aspect-video bg-muted relative">
              ...
              />
              {product.farmerVerified && <Badge className="absolute top-2 right-2 bg-primary">Verified</Badge>}
            </div>
            <CardHeader>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-foreground">{product.available}</span>
                </div>
                <div className="flex justify-between items-center">
